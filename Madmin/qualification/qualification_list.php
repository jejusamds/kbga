...
function deleteEntries(){
    ...
    if(confirm('선택한 항목을 삭제하시겠습니까?')){
        location.href='/Madmin/qualification/exec.php?table=<?= $table ?>&mode=delete&selidx='+arr.join('|')+'&page=<?= $page ?>';
    }
}
</script>
<div class="pageWrap">
            ...
            <table class="table" cellpadding="0" cellspacing="0">
                ...
                <?php if ($total > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="comALeft"><a href="qualification_input.php?mode=update&idx=<?= $row['idx'] ?>&page=<?= $page ?>"><?= htmlspecialchars($row['f_name'],ENT_QUOTES) ?></a></td>
                    ...
                    <?php endforeach; ?>
                <?php else: ?>
                    <tr><td colspan="7" class="comACenter" height="50">등록된 데이터가 없습니다.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
    ...
    <div class="box comMTop20 comMBottom20" style="width:1114px;">
        <div class="comPTop20 comPBottom20">
            ...
            <div class="comFRight comARight" style="width:15%; padding-right:10px;">
                <button class="btn btn-default btn-sm" type="button" onclick="location.href='qualification_input.php?page=<?= $page ?>';">등록</button>
            </div>
            <div class="clear"></div>
        </div>
    </div>
