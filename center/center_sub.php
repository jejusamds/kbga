                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" class="receipt_td">
                                                                                            <span>
                <?= htmlspecialchars($row['f_registration_start']) ?> ~ <?= htmlspecialchars($row['f_registration_end']) ?>
                                                                                            </span>
                                                                                        </td>
                                                                                        <td align="center" class="exam_td">
                                                                                            <span>
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="center" class="receipt_td">
                                                                                            <span>
                <?= htmlspecialchars($row['f_registration_start_2']) ?> ~ <?= htmlspecialchars($row['f_registration_end_2']) ?>
                                                                                            </span>
                                                                                        </td>
                                                                                        <td align="center" class="exam_td">
                                                                                            <span>
