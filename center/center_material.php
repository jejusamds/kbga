...
$rows = $db->query(
    "SELECT m.*, qi.f_item_name FROM df_site_material m LEFT JOIN df_site_qualification_item qi ON m.f_subject_idx = qi.idx WHERE m.f_category=:cat {$searchSql} ORDER BY qi.f_item_name ASC, m.idx DESC",
    $params
);
